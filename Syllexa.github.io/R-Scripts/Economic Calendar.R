...
setwd("C:\\Users\\Vishu\\OneDrive\\Weekly Digest\\Calender csv")  
...
length<-grep("Click to View",doc,ignore.case = T)

NEWS<-doc[length+1] #Finding all xls files 

NEWS<- as.data.frame(NEWS)

NEWS$NEWS<- as.character(NEWS$NEWS)
NEWS$Country<- doc[length-2]
NEWS$News<-0
...
Table<-datatable(NEWS, class = 'table-bordered table-condensed',options = list(pageLength = 15),caption = Economic_Calender)

save_html(Table,"C:\\Users\\Vishu\\OneDrive\\Weekly Digest\\HTML\\Web Files\\Economic Calendar.html")
